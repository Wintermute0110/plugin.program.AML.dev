...
def fs_get_cataloged_dic_parents(PATHS, catalog_name):
    ...
    elif catalog_name == 'Controls_Expanded': catalog_dic = fs_load_JSON_file(PATHS.CATALOG_CONTROL_EXPANDED_PARENT_PATH.getPath())
    elif catalog_name == 'Controls_Compact':  catalog_dic = fs_load_JSON_file(PATHS.CATALOG_CONTROL_COMPACT_PARENT_PATH.getPath())
    ...
    elif catalog_name == 'Devices_Expanded':  catalog_dic = fs_load_JSON_file(PATHS.CATALOG_DEVICE_EXPANDED_PARENT_PATH.getPath())
    elif catalog_name == 'Devices_Compact':   catalog_dic = fs_load_JSON_file(PATHS.CATALOG_DEVICE_COMPACT_PARENT_PATH.getPath())
...
def fs_get_cataloged_dic_all(PATHS, catalog_name):
    ...
    elif catalog_name == 'Controls_Expanded': catalog_dic = fs_load_JSON_file(PATHS.CATALOG_CONTROL_EXPANDED_ALL_PATH.getPath())
    elif catalog_name == 'Controls_Compact':  catalog_dic = fs_load_JSON_file(PATHS.CATALOG_CONTROL_COMPACT_ALL_PATH.getPath())
    ...
    elif catalog_name == 'Devices_Expanded':  catalog_dic = fs_load_JSON_file(PATHS.CATALOG_DEVICE_EXPANDED_ALL_PATH.getPath())
    elif catalog_name == 'Devices_Compact':   catalog_dic = fs_load_JSON_file(PATHS.CATALOG_DEVICE_COMPACT_ALL_PATH.getPath())
