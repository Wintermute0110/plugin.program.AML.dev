...
def fs_scan_MAME_assets(PATHS, assets_dic, control_dic, machines_render, main_pclone_dic, Asset_path_FN, pDialog):
    ...
    report_str_list.append('Have PCBs       {0:5d} (Missing {1:5d}, Alternate {2:5d})'.format(PCB[0],  PCB[1],  PCB[2]))
    report_str_list.append('Have Artpreview {0:5d} (Missing {1:5d}, Alternate {2:5d})'.format(Artp[0], Artp[1], Artp[2]))
    report_str_list.append('Have Artwork    {0:5d} (Missing {1:5d}, Alternate {2:5d})'.format(Art[0],  Art[1],  Art[2]))
    report_str_list.append('Have Cabinets   {0:5d} (Missing {1:5d}, Alternate {2:5d})'.format(Cab[0],  Cab[1],  Cab[2]))
    report_str_list.append('Have Clearlogos {0:5d} (Missing {1:5d}, Alternate {2:5d})'.format(Clr[0],  Clr[1],  Clr[2]))
    report_str_list.append('Have CPanels    {0:5d} (Missing {1:5d}, Alternate {2:5d})'.format(CPan[0], CPan[1], CPan[2]))
    report_str_list.append('Have Fanarts    {0:5d} (Missing {1:5d}, Alternate {2:5d})'.format(Fan[0],  Fan[1],  Fan[2]))
    report_str_list.append('Have Flyers     {0:5d} (Missing {1:5d}, Alternate {2:5d})'.format(Fly[0],  Fly[1],  Fly[2]))
    report_str_list.append('Have Manuals    {0:5d} (Missing {1:5d}, Alternate {2:5d})'.format(Man[0],  Man[1],  Man[2]))
    report_str_list.append('Have Marquees   {0:5d} (Missing {1:5d}, Alternate {2:5d})'.format(Mar[0],  Mar[1],  Mar[2]))
    report_str_list.append('Have Snaps      {0:5d} (Missing {1:5d}, Alternate {2:5d})'.format(Snap[0], Snap[1], Snap[2]))
    report_str_list.append('Have Titles     {0:5d} (Missing {1:5d}, Alternate {2:5d})'.format(Tit[0],  Tit[1],  Tit[2]))
    report_str_list.append('Have Trailers   {0:5d} (Missing {1:5d}, Alternate {2:5d})'.format(Tra[0],  Tra[1],  Tra[2]))
